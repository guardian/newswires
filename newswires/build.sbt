...
libraryDependencies += "com.gu" %% "simple-configuration-ssm" % "14.0.1"
libraryDependencies += "com.gu" %% "pan-domain-auth-play_3-0" % "22.0.0"
libraryDependencies += "com.gu" %% "editorial-permissions-client" % "8.0.0"
