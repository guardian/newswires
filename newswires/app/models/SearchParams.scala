...
case class FilterParams(
    ...
    categoryCodesOrIncl: List[String],
    categoryCodesAndIncl: List[String],
  ...
  def build(
    ...
    SearchParams(
      FilterParams(
        ...
        categoryCodesOrIncl = baseParams.categoryCode,
        categoryCodesAndIncl = baseParams.categoryCodeAnd,
